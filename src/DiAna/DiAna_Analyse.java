...
public class DiAna_Analyse extends JFrame implements MouseListener {
    ...
    int nbImg, oldNbImg;
    String[] title;
    String imgASelect, imgBSelect, imgA2Select, imgB2Select, imgMaskSelect;
    ...
    //macro
    private String imgTitle1, imgTitle2, labTitle1, labTitle2;
    boolean colocBool=false, adjaBool=false, shuffleBool=false, measureBool=false;
    int numClo;
    double distC, distA;
     ...
     */
    public void macroBatchRunner(ImagePlus img1, ImagePlus img2, ImagePlus lab1, ImagePlus lab2){
        ...
        if(colocBool){
            meas.computeColoc(true, true, true, true, true, true, false, distC);
         }
        if(adjaBool){
            meas.ComputeAdjacency(numClo, true, true, true, true, false, distA);
        }
        if(shuffleBool){
            //TODO
        }
        if(measureBool){
            ResultsTable resultsA = Measures.measureResult(iHandA, popA, "ObjA-", true, true, true, true,true, true, true, true);
            ResultsTable resultsB = Measures.measureResult(iHandB, popB, "ObjB-", true, true, true, true,true, true, true, true);
...
//        IJ.log("interpreterLAB1="+labTitle1+"interpreterLAB2="+labTitle2);
        ...
        if(shuffleBool){
              //TODO
              //if mask=image Title, else
        }
//        if(measureBool){
//            
//        }
        macroBatchRunner(im1, im2, im3, im4);
    }
 ...
 */
    public void macroGenerator(String title1, String title2, String title3, String title4){
        ...
        if(colocBool==true){
              ...
              command=command+" coloc"+" distc="+distC;
              //IJ.log("macro commandLine: "+"img1="+title1+" img2="+title2+" lab1="+title3+" lab2="+title4+" coloc"+" distc="+distC);
              //save ROI?
        }
        if(adjaBool==true){
              ...
              command=command+" adja "+"kclosest="+numClo+" dista="+distA;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/allAllico.gif"))); // NOI18N
        ...
        allAllPanelLayout.setHorizontalGroup(
            ...
            .addGroup(allAllPanelLayout.createSequentialGroup()
                .addGroup(allAllPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(allAllPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(MeasuresTabbedPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 478, Short.MAX_VALUE)))
                .addContainerGap())
        );
        allAllPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, allAllPanelLayout.createSequentialGroup()
                ...
                .addComponent(measAnaLab1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(MeasuresTabbedPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void imgAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imgAActionPerformed
        ...
        /*if(!imgASelect.equals(Manager.plus1.getTitle())){
            WindowManager.getFrame(imgASelect).toFront();
            int slice = WindowManager.getImage(imgASelect).getNSlices();
            WindowManager.getImage(imgASelect).setSlice(slice/2);
            imgA.updateUI();
    ...
    private void imgBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imgBActionPerformed
        ...
        /*if(!imgBSelect.equals(Manager.plus2.getTitle())){
    ...
    private void aboutMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aboutMouseReleased
      ...
      private void analyseMeasuresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_analyseMeasuresActionPerformed
        if(init==true){
            ...
            ResultsTable resultsA = Measures.measureResult(iHA, currPopA, "ObjA-", volumebool, meanbool, surfacebool, minMaxbool, stdDevbool, centrobool, massbool, feretbool);
            ResultsTable resultsB = Measures.measureResult(iHB, currPopB, "ObjB-", volumebool, meanbool, surfacebool, minMaxbool, stdDevbool, centrobool, massbool, feretbool);
            resultsA.show("ObjectsMeasuresResults-A");
            resultsB.show("ObjectsMeasuresResults-B");
      ...
      private void analyseShuffleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_analyseShuffleActionPerformed
        if(init==true){
            ...
            if(shufflebounds1.isSelected()){
                ...
                //mask2= Measures.getmask(iHandA, true);
            }
            if(shufflebounds2.isSelected()){
                ...
                //mask2 = Measures.getmask(ihMask, false);
            }
      ...
      private void analyseAdjacencyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_analyseAdjacencyActionPerformed
        if(init==true){
            numClo = Integer.parseInt((String) closestField1.getText());
...
//        }
    ...
    private void updatePrefs(){
        ...
        if (Recorder.record) {
            macroGenerator(imgTitle1, imgTitle2, labTitle1, labTitle2);
        }
    }
