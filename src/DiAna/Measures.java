...
//        IJ.log("measurTouchA="+touchA.getNbObjects()+"measurTouchB="+touchB.getNbObjects());
        ...
        IJ.log("avant les mesures "+sdf.format(cal.getTime()));
        IJ.log("surf?="+surf);
...
//                    if(colocEE==true){rtColoc.addValue("Dist EdgeA-EdgeB", obA.distBorderUnit(obB));}
     ...
     * @return 
     */
    public static ResultsTable measureResult(ImageHandler rawimage, Objects3DPopulation pop, String prefix, boolean volume, boolean  mean, boolean  surface, boolean minMax, boolean  stdDev, boolean centro, boolean mass, boolean feret){
        ...
        for(int i=0; i<pop.getNbObjects(); i++){
            ...
            if(surface==true){
                ...
                rt.addValue("surfaceAreaPxl", pop.getObject(i).getAreaPixels());
            }
            if(minMax==true){
